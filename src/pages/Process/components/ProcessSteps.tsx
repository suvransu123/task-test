...
const STEPS: ProcessStepData[] = [
  {
    ...
    image:'/image/problem_statement.png',
    imageClass: '',
  ...
  },
  {
    ...
    image:'/image/Technical_Architecture.png',
    imageClass: 'rounded-none mt-3',
    containerClass: 'bg-emerald-950',
    visual: <Step2Visual />,
  },
  {
    step: 3,
    ...
    image:'/image/stakeHolder.png',
    imageClass: 'shadow-2xl',
    containerClass: 'bg-violet-950',
    visual: <Step3Visual />,
  },
  {
    step: 4,
    ...
    image:'/image/Capabilities-image-1.png',
    imageClass: 'translate-y-2',
    containerClass: 'bg-rose-950',
    visual: <Step4Visual />,
  },
  {
    step: 5,
    ...
    imageClass: 'shadow-inner',
    containerClass: 'bg-amber-950',
    visual: <Step5Visual />,
    isDark: true,
  },
]
